  ...
  <div class="mb-4">
    <div class="block md:hidden">
      <div class="flex items-center justify-between text-xs">
        <!-- Niveau -->
        <div class="dropdown">
          <label tabindex="0" class="btn m-1">Niveau <Icon name="fe:arrow-down" /></label>
          <ul
            tabindex="0"
        ...
        <!-- Location -->
        <div class="dropdown">
          <label tabindex="0" class="btn m-1">Location <Icon name="fe:arrow-down" /></label>
          <ul
            tabindex="0"
        ...
        <!-- Motivation -->
        <div class="dropdown">
          <label tabindex="0" class="btn m-1">Motivation <Icon name="fe:arrow-down" /></label>
          <ul
            tabindex="0"
            class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52"
          >
